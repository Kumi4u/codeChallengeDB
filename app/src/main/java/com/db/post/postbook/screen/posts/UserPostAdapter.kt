...
class UserPostAdapter(val userPostList: List<UserPost>, val onUserPostClickListener: OnUserPostClickListener, val onPostFavClickListner: OnPostFavClickListener) :
